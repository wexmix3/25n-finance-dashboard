...
function buildSectionFlags(current: FinancialData, prior: FinancialData): SectionFlag[] {
  ...
  const sections: { label: string; curr: number; prev: number; isRevenue: boolean }[] = [
    ...
    { label: "Staffing Costs",      curr: is.opex.payroll.actual,              prev: ip.opex.payroll.actual,              isRevenue: false },
    ...
    { label: "Professional Fees",   curr: is.opex.professional_fees.actual,    prev: ip.opex.professional_fees.actual,    isRevenue: false },
    { label: "Bad Debt",            curr: is.opex.bad_debt.actual,             prev: ip.opex.bad_debt.actual,             isRevenue: false },
    { label: "Depreciation",        curr: is.opex.depreciation.actual,         prev: ip.opex.depreciation.actual,         isRevenue: false },
    { label: "License & Business Fees", curr: is.opex.license_business_fees.actual, prev: ip.opex.license_business_fees.actual, isRevenue: false },
